        ...
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <div className="bg-black text-white p-8 md:p-12 rounded-lg text-center space-y-6">
            ...
            <p className="text-gray-300 text-base md:text-lg">
              Jump into the live business simulation and test your entrepreneurial thinking.
            </p>
            <a 
              href="https://warroom-frontend-410969764896.us-central1.run.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block px-6 md:px-8 py-3 md:py-4 bg-yellow-500 text-black text-sm md:text-base font-bold rounded hover:bg-yellow-600 transition-all duration-300 hover:scale-105"
            >
              ENTER THE WAR ROOM
            </a>
          </div>
