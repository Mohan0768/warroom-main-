      ...
      <section className="py-16 md:py-20 px-4 md:px-6 bg-white">
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              <div className="space-y-4">
                <h3 className="text-lg md:text-xl font-bold" style={{ color: '#FFC107' }}>6 Intensive Stages</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-lg md:text-xl font-bold" style={{ color: '#FFC107' }}>Real Decision Making</h3>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="space-y-4">
                <h3 className="text-lg md:text-xl font-bold" style={{ color: '#FFC107' }}>Consequence-Driven Learning</h3>
                <p className="text-gray-700 leading-relaxed">
                  Understand cause and effect in business. Every decision has consequences—learn without the financial risk of real failure.
                </p>
              </div>
              <div className="space-y-4">
                <h3 className="text-lg md:text-xl font-bold" style={{ color: '#FFC107' }}>Risk-Free Environment</h3>
                <p className="text-gray-700 leading-relaxed">
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 md:p-8 rounded-lg space-y-4" style={{ backgroundColor: 'rgba(255, 193, 7, 0.1)', borderLeft: '4px solid #FFC107' }}>
              <p className="text-gray-700 leading-relaxed">
