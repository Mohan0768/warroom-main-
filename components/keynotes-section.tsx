        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <p className="text-xs font-semibold tracking-widest" style={{ color: '#FFC107' }}>SPEAKING ENGAGEMENTS</p>
            ...
            <div className="bg-gray-50 p-6 space-y-4" style={{ borderLeft: '4px solid #FFC107' }}>
