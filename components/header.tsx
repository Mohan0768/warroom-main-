      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 md:py-4 transition-all duration-300">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-2 lg:gap-3">
            ...
            <a href="https://calendly.com/mohan20051028/new-meeting" target="_blank" rel="noopener noreferrer" className="px-4 lg:px-6 py-2 bg-yellow-500 text-black text-xs md:text-sm font-medium rounded hover:bg-yellow-600 transition-all duration-300 hover:shadow-lg hover:scale-105">
              BOOK A CALL
            </a>
          </div>
